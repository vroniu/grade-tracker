...
namespace grade_tracker.Migrations
{
    ...
    [Migration("20220524200012_InitialCreate")]
            ...
            modelBuilder.Entity("SubjectTeacher", b =>
                {
                    ...
                    b.Property<int>("TeachersStudentId")
                        .HasColumnType("INTEGER");

                    b.HasKey("SubjectsToTeachSubjectId", "TeachersStudentId");

                    b.HasIndex("TeachersStudentId");
            ...
            modelBuilder.Entity("SubjectTeacher", b =>
                {
                    ...
                    b.HasOne("grade_tracker.Models.Teacher", null)
                        .WithMany()
                        .HasForeignKey("TeachersStudentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
